...
public class EmailSend {
	public String connectEmail(String email){
		...
		String subject="BUsk 회원가입 인증메일입니다."; // 보내는 제목 설정
		String fromName="관리자"; // 보내는 이름 설정
		String from="miing1214@gamil.com"; // 보내는 사람(구글계정)
		String authNum=EmailSend.authNum(); // 인증번호 위한 난수 발생부분
           ...
           = Session.getInstance(props,new javax.mail.Authenticator(){
			    protected PasswordAuthentication getPasswordAuthentication(){
				    return new PasswordAuthentication
                                        ("miing1214@gmail.com","mnyywsuaemkjxbad"); // gmail계정
			}
		});
